...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        persentase = findViewById(R.id.persentase_bar);
        ...
        final Handler handler = new Handler(){
            ...
            public void handleMessage(Message msg) {
                ...
                if(Value == progressBar.getMax()){
                    Toast.makeText(getApplicationContext(), "Semoga travelingnya menyenangkan", Toast.LENGTH_SHORT).show();
            ...
            public void run() {
                try{
                    for(int w=0; w<=progressBar.getMax(); w++){
                        ...
                        Thread.sleep(30); // Waktu Pending 100ms/0.1 detik
                    }
