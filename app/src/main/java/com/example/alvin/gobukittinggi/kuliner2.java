...
public class kuliner2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map = (Button)findViewById(R.id.maps_kuliner2_id);

        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent map = new Intent(getApplicationContext(), maps_kuliner2.class);
                startActivity(map);
            }
        });
        ...
        collapsingToolbarLayout.setTitle("Family Benteng");
