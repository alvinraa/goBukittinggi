...
public class kuliner3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map = (Button)findViewById(R.id.maps_kuliner3_id);

        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent map = new Intent(getApplicationContext(), maps_kuliner3.class);
                startActivity(map);
            }
        });
        ...
        collapsingToolbarLayout.setTitle("Keripik Sanjai");
