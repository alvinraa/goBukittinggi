...
public class wisata2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map = (Button)findViewById(R.id.maps_wisata2_id);

        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent map = new Intent(getApplicationContext(), maps_wisata2.class);
                startActivity(map);
            }
        });
        ...
        collapsingToolbarLayout.setTitle("Kinantan Zoo");
