...
public class wisata3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map = (Button)findViewById(R.id.maps_wisata3_id);

        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent map = new Intent(getApplicationContext(), maps_wisata3.class);
                startActivity(map);
            }
        });
        ...
        collapsingToolbarLayout.setTitle("Lubang Jepang");
